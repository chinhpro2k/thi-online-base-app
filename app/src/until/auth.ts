import { APP_ICON } from '@/core/tools'
...
export const authKeycloak = (): Promise<AuthResponseKeyCloak> => {
  return new Promise((resolve, reject) => {
    ...
    authWindow.loadURL(
      ...
      'https://dhs-demo.aisenote.com/auth/realms/master/protocol/openid-connect/auth?client_id=slink-electron&redirect_uri=http://localhost:13311'
    )
    authWindow.on('close', () => {
      authWindow.destroy()
    })
    ...
    authWindow.webContents.on('will-navigate', function (event: any, newUrl: any) {
